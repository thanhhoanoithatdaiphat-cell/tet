...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-DXUwLKlL.js
...
var DB = "nct-media";
var STORE = "files";
var IMAGE_MAX = 10485760;
var VIDEO_MAX = 41943040;
function openDb() {
...
async function compressImage(file) {
	...
	bmp.close();
	return await new Promise((r) => canvas.toBlob(r, "image/jpeg", .86)) ?? file;
}
var useMedia = create((set, get) => ({
	urls: {},
	ready: false,
	hydrate: async () => {
		if (get().ready) return;
...
var styles_default = "/assets/styles-C_ID9l57.css";
var APP_NAME = "Nhà Có Tết";
...
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Set Tết hiện đại cho chung cư và nhà phố. Set cửa 399k, phòng khách 699k, cả nhà 999k. COD, giao trước Tết."
			},
			{
				name: "theme-color",
				content: "#8F2D2D"
	...
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MediaHydrator, {}),
...
var $$splitComponentImporter$1 = () => import("./routes-DqyV85Fq.mjs");
var Route$1 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./van-hanh-CcY1V6X9.mjs");
var Route = createFileRoute("/van-hanh")({
	component: lazyRouteComponent($$splitComponentImporter, "component"),
	head: () => ({ meta: [{ title: "Vận hành · Nhà Có Tết" }] })
});
